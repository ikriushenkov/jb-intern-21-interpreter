...
class FunctionDefinition(val identifier: Identifier,
                         private val parameterList: List<Identifier>,
                         val expression: Expression) {
    fun run(valueList: List<Expression>,
            identifierToFunction: Map<Identifier, FunctionDefinition>, line: Int): Int {
